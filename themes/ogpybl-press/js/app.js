...
$('.staff-card-front img').click(function(e){
  var imgSrc = e.currentTarget.src;
  var staffBack = e.currentTarget.parentElement.parentElement.nextElementSibling.innerHTML;
...
//     console.log(selectors.item.toArray());
...
// //           to switch pictures either fwd or back  default max-40, min- 100 
//         } else if ((pos + 200) <= max - 40 && (pos + 200) >= min - 100) {
// //           console.log(pos, max, min, '2nd');
//           selectors.id.css(
//             "background-image",
//             "url(" +
//               $(this)
...
//     );
    var itemLength = selectors.item.length;
    var timelineArray = selectors.item.toArray()
//     console.table(timelineArray);
    $('#timeline-1').scroll(function() {
      var max, min;
      var pos = $(this).scrollTop();
      console.log(pos);
      switchTimeline(pos);
      ...
      function switchTimeline(pos){
        switch(true) {
            case (pos < 500):
            timelineArray[0].classList.add('timeline-item--active');
            timelineArray[1].classList.add('timeline-item--active');
            timelineArray[2].classList.add('timeline-item--active');
            for(var i = 3; i < timelineArray.length; i++) {
              timelineArray[i].classList.remove('timeline-item--active');
            }
//             show first three
            break;
               case (pos > 500 && pos < 1000):
            timelineArray[3].classList.add('timeline-item--active');
            timelineArray[4].classList.add('timeline-item--active');
            timelineArray[5].classList.add('timeline-item--active');
            for(var i = 0; i < 3; i++) {
              timelineArray[i].classList.remove('timeline-item--active');
            }
            for(var i = 6; i < timelineArray.length; i++) {
              timelineArray[i].classList.remove('timeline-item--active');
            }
//             show first three
            break;
               case (pos > 1000 && pos < 1500):
            timelineArray[6].classList.add('timeline-item--active');
            timelineArray[7].classList.add('timeline-item--active');
            timelineArray[8].classList.add('timeline-item--active');
            for(var i = 0; i < 6; i++) {
              timelineArray[i].classList.remove('timeline-item--active');
            }
            for(var i = 9; i < timelineArray.length; i++) {
              timelineArray[i].classList.remove('timeline-item--active');
            }
//             show first three
            break;
               case (pos > 1500 && pos < 2000):
            timelineArray[9].classList.add('timeline-item--active');
            timelineArray[10].classList.add('timeline-item--active');
            timelineArray[11].classList.add('timeline-item--active');
            for(var i = 0; i < 9; i++) {
              timelineArray[i].classList.remove('timeline-item--active');
            }
            for(var i = 12; i < timelineArray.length; i++) {
              timelineArray[i].classList.remove('timeline-item--active');
            }
//             show first three
            break;
               case (pos > 2000):
            timelineArray[12].classList.add('timeline-item--active');
            timelineArray[13].classList.add('timeline-item--active');
            for(var i = 0; i < 12; i++) {
              timelineArray[i].classList.remove('timeline-item--active');
            }
//             show first three
...
$("#timeline-1").timeline();
// $('.timeline-item').hover(
//   if($(this).hasClass('timeline-item--active')) {
//   function() {
